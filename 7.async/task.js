...
PhoneClock.addClock('06:48', () => console.log ("Доброе утро!"), 1);
PhoneClock.addClock('06:49', () => console.log ("Пора вставать уже!"), 2);
PhoneClock.removeClock(2);
PhoneClock.addClock('06:50', () => console.log ("Ты все проспишь!"), 3);
PhoneClock.start();
PhoneClock.stop();
